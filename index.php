...
<body>
	...
	<div id="header">
		<div class="clearfix1">
        	<div id="logo">
            	<a href="mangaking.esy.es"><img src="Pictures/Logo.png" /></a>
            </div>
        	<div id="banner">
	...
	<div id="contents">
		<div id="slider">
        	...
        	<div id="slider-img1">
                <a href="#"><img id="slider-img1-img" onMouseOver="bigImg1()" onMouseOut="normalImg()" src="Pictures/slider1.png" /></a>
            </div>
            <div id="slider-img2">
                <a href="#"><img id="slider-img2-img" onMouseOver="bigImg2()" onMouseOut="normalImg()" src="Pictures/slider2.png" /></a>
            </div>
            <div id="slider-img3">
                <a href="#"><img id="slider-img3-img" src="Pictures/slider3.png" /></a>
            </div>
            <div id="slider-img4">
                <a href="#"><img id="slider-img4-img" onMouseOver="bigImg4()" onMouseOut="normalImg()" src="Pictures/slider4.png" /></a>
            </div>
            <div id="slider-img5">
                <a href="#"><img id="slider-img5-img" onMouseOver="bigImg5()" onMouseOut="normalImg()" src="Pictures/slider5.png" /></a>
            </div>
        </div>
        <div class="clearfix">
        	<div id="column1">
                ...
                <div id="column1-hot-manga">
                	<div class="column1-content-part1">
                    	<?php include"hot-manga-home-page1.php"; ?>
                    </div>
                    <div class="column1-content-part2">
                    	<?php include"hot-manga-home-page2.php"; ?>
                    </div>
                </div>
                <div id="column1-latest-update-manga">
                	<div class="column1-content-part1">
                    	<?php include"latest-update-manga-home-page1.php"; ?>
                    </div>
                    <div class="column1-content-part2">
                    	<?php include"latest-update-manga-home-page2.php"; ?>
                    </div>
                </div>
                <div id="column1-new-manga">
                	<div class="column1-content-part1">
                    	<?php include"new-manga-home-page1.php"; ?>
                    </div>
                    <div class="column1-content-part2">
                    	<?php include"new-manga-home-page2.php"; ?>
                    </div>
                </div>
            </div>
            <div id="column2">
