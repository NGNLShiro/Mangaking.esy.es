...
<?php
	$a = $_GET['a'];
	$tbname = $_GET['tbname'];
	$tbnamechapter = $_GET['tbnamechapter'];
	$tbnamechaptercontent = $_GET['tbnamechaptercontent'];
	$bxh = "bxh";
?>
...
<body>
	...
	<div id="header">
		<div class="clearfix1">
        	<div id="logo">
            	<a href="../Adventure Boy/mangaking.esy.es"><img src="../../contents/img/Logo.png" /></a>
            </div>
        	<div id="banner">
			...
			<div id="navigation">
                ...
                <form action="../../app/admin/Search Result.php" method="post">
