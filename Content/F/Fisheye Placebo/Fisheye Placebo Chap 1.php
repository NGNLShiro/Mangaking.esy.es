...
<?php
	...
	$b = 9;
	$tbname = "manga-name-f";
	$tbnamechapter = "manga-name-f-chapter";
	$tbnamechaptercontent = "manga-name-f-chapter-content";
?>
...
<body>
	...
	<div id="header">
		<div class="clearfix1">
            <div id="logo">
            	<a href="../Fureru to Kikoeru/mangaking.esy.es"><img src="../../../Pictures/Logo.png" /></a>
            </div>
        	<div id="banner">
