...
<?php
	$a = 1;
	$tbname = "manga-name-b";
	$tbnamechapter = "manga-name-b-chapter";
	$tbnamechaptercontent = "manga-name-b-chapter-content";
	$bxh = "bxh";
?>
...
<body>
	...
	<div id="header">
		<div class="clearfix1">
        	<div id="logo">
            	<a href="../../A/Adventure Boy/mangaking.esy.es"><img src="../../../Pictures/Logo.png" /></a>
            </div>
        	<div id="banner">
